...
:: 2. Clone Repository
@REM if exist MumzkidFaceSwap (
@REM     echo MumzkidFaceSwap directory already exists.
@REM     set /p overwrite="Do you want to overwrite? (Y/N): "
@REM     if /i "%overwrite%"=="Y" (
@REM         rmdir /s /q MumzkidFaceSwap
@REM         https://github.com/Mumzkid4/MumzkidFaceSwap.git
@REM     ) else (
@REM         echo Skipping clone, using existing directory.
@REM     )
@REM ) else (
@REM     git clone https://github.com/Mumzkid4/MumzkidFaceSwap.git
@REM )
@REM cd MumzkidFaceSwap

:: 3. Download Models
echo Downloading models...
if not exist models mkdir models
curl -L -o models\GFPGANv1.4.pth https://huggingface.co/Mumzkid04/GFPGANv1.4/blob/main/GFPGANv1.4.pth
curl -L -o models\inswapper_128_fp16.onnx https://huggingface.co/Mumzkid04/GFPGANv1.4/blob/main/inswapper_128_fp16.onnx
...
echo 6. None
set /p choice="Enter your choice (1-6): also remeber to enter the number based on the kind of processing acceleration you are using, press 1 for Nvidia users "
